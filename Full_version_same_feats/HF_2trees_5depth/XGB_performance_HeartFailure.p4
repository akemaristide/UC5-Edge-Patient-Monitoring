...
control SwitchIngress(
    ...
    action extract_feature5(out bit<2> meta_code, bit<2> tree){
        meta_code = tree;
    }
    ...
    action extract_feature7(out bit<6> meta_code, bit<6> tree){
        meta_code = tree;
    }

    action extract_feature8(out bit<10> meta_code, bit<10> tree){
        meta_code = tree;
    }

    action extract_feature9(out bit<4> meta_code, bit<4> tree){
        meta_code = tree;
    }
    ...
    table lookup_leaf_id0 {
        key = { meta.code_f0[2:0]:exact;
                ...
                meta.code_f6[1:0]:exact;
                meta.code_f7[2:0]:exact;
                meta.code_f8[4:0]:exact;
    ...
    table lookup_leaf_id1 {
        key = { meta.code_f0[5:3]:exact;
                ...
                meta.code_f3[1:1]:exact;
                meta.code_f4[5:3]:exact;
                meta.code_f5[1:1]:exact;
                meta.code_f6[3:2]:exact;
                meta.code_f7[5:3]:exact;
                meta.code_f8[9:5]:exact;
